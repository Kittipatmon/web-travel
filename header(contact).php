        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                        <li><a href="index.php"><img src="assets/images/home.png" alt="" style="width: 20px; height: 20px; margin-bottom: 10px;"> Home</a></li>
                        <li><a href="contact.php" class="active"><img src="assets/images/contact.png" alt="" style="width: 20px; height: 20px; margin-bottom: 10px;"> Contact Us</a></li>
